...
<execution_context>
@/home/chemtech/workspace/xcfun_rs/.claude/get-shit-done/workflows/settings-advanced.md
</execution_context>

<process>
**Follow the settings-advanced workflow** from `@/home/chemtech/workspace/xcfun_rs/.claude/get-shit-done/workflows/settings-advanced.md`.
