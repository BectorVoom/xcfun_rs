...
```bash
INIT=$(node "/home/chemtech/workspace/xcfun_rs/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/chemtech/workspace/xcfun_rs/.claude/get-shit-done/templates/spec.md.
