...
```bash
INIT=$(node "/home/user/Documents/workspace/xcfun_rs/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/user/Documents/workspace/xcfun_rs/.claude/get-shit-done/templates/spec.md.
