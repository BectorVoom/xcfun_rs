...
@/home/user/Documents/workspace/xcfun_rs/.claude/get-shit-done/references/git-integration.md
</required_reading>
...
See `/home/user/Documents/workspace/xcfun_rs/.claude/get-shit-done/references/tdd.md` for structure.
</tdd_plan_execution>
...
See /home/user/Documents/workspace/xcfun_rs/.claude/get-shit-done/references/checkpoints.md for details.
</step>
...
Create `{phase}-{plan}-SUMMARY.md` at `.planning/phases/XX-name/`. Use `/home/user/Documents/workspace/xcfun_rs/.claude/get-shit-done/templates/summary.md`.
