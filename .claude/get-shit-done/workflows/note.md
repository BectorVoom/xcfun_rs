...
- **Global scope**: `/home/chemtech/workspace/xcfun_rs/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/chemtech/workspace/xcfun_rs/.claude/notes/`)
...
2. Glob `/home/chemtech/workspace/xcfun_rs/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/chemtech/workspace/xcfun_rs/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/chemtech/workspace/xcfun_rs/.claude/notes/` — works in any directory
