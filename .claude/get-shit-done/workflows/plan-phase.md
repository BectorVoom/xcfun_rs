...
**If found:**
1. Read template: `/home/chemtech/workspace/xcfun_rs/.claude/get-shit-done/templates/VALIDATION.md`
...
${TDD_MODE === 'true' ? `
<tdd_mode_active>
**TDD Mode is ENABLED.** Apply TDD heuristics from @/home/chemtech/workspace/xcfun_rs/.claude/get-shit-done/references/tdd.md to all eligible tasks:
