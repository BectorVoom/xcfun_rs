...
```bash
INIT=$(node "/home/user/Documents/workspace/xcfun_rs/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/user/Documents/workspace/xcfun_rs/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
