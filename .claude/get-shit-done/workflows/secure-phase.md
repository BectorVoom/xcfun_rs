...
```
Task(
  prompt="Read /home/chemtech/workspace/xcfun_rs/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/chemtech/workspace/xcfun_rs/.claude/get-shit-done/templates/SECURITY.md`
