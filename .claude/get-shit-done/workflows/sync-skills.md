...
INSTALL_JS_GLOBAL="/home/user/Documents/workspace/xcfun_rs/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/user/Documents/workspace/xcfun_rs/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
