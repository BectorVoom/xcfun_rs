...
INSTALL_JS_GLOBAL="/home/chemtech/workspace/xcfun_rs/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/chemtech/workspace/xcfun_rs/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
