...
- Usage: Reference from command with `@/home/user/Documents/workspace/xcfun_rs/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/user/Documents/workspace/xcfun_rs/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/user/Documents/workspace/xcfun_rs/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
