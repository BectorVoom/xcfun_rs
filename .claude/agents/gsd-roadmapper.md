...
Reference full template: `/home/chemtech/workspace/xcfun_rs/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/chemtech/workspace/xcfun_rs/.claude/get-shit-done/templates/state.md`.
