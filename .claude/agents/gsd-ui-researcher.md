...
Use template from `/home/chemtech/workspace/xcfun_rs/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/chemtech/workspace/xcfun_rs/.claude/get-shit-done/templates/UI-SPEC.md`
