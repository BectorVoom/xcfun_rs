...
<reference>
@/home/chemtech/workspace/xcfun_rs/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/chemtech/workspace/xcfun_rs/.claude/get-shit-done/references/user-profiling.md` to load:
