...
- [ ] **AD-01**: `CTaylor<F: Float, const N: u32>` is a pure `#[cube]` type for `N ∈ 0..=7`, backed by a cubecl `Array<F>` of length `1 << N`, bit-flag-indexed (`CNST = 0`, `VAR0 = 1`, …, `VAR6 = 64` exposed as host `pub const`). Algorithmic identity with `xcfun-master/external/upstream/taylor/ctaylor.hpp` is preserved inside the `#[cube]` source.
