//! XC_REVPBEX — Revised PBE Exchange Functional. GGA-01.
//!
//! # Source
//! - `xcfun-master/src/functionals/revpbex.cpp:18-21`
//!
//! # Formula
//! ```cpp
...
use crate::functionals::gga::shared::constants::R_REVPBE_F64;
use crate::functionals::gga::shared::pbex as pbex_shared;

#[cube]
pub fn revpbex_kernel<F: Float>(d: &DensVarsDev<F>, out: &mut Array<F>, #[comptime] n: u32) {
    let size = comptime!((1_u32 << n) as usize);
    let r = F::cast_from(R_REVPBE_F64);
