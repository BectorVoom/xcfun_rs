//! XC_B97_2X — B97-2 GGA exchange. **GGA-09 (B97_2X, id=64).**
//!
//! # Source
//! - `xcfun-master/src/functionals/b97-2xc.cpp:20-23`   (b97_2x_en aggregator)
...
//! `B97_2X_COEF = [0.827642, 0.047840, 1.76125]`.
...
pub fn b97_2x_kernel<F: Float>(
    ...
    let c0 = F::cast_from(B97_2X_COEF[0]);
    let c1 = F::cast_from(B97_2X_COEF[1]);
    let c2 = F::cast_from(B97_2X_COEF[2]);
