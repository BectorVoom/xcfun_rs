//! Phase 6 Plan 06-N1 (B-6 revision-1) — D-19 regression detector for PBEINTC.
//!
//! Loads `validation/fixtures/d19_n1/pbeintc_baseline.jsonl` and asserts the
//! current Rust `pbeintc_kernel` output (energy / CNST coefficient at N=0)
...
#[test]
fn d19_pbeintc_baseline_regression() {
    let path = fixture_path("pbeintc");
