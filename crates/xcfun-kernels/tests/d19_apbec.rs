//! Phase 6 Plan 06-N1 (B-6 revision-1) — D-19 regression detector for APBEC.
//!
//! Loads `validation/fixtures/d19_n1/apbec_baseline.jsonl` and asserts the
//! current Rust `apbec_kernel` output (energy / CNST coefficient at N=0)
...
#[test]
fn d19_apbec_baseline_regression() {
    let path = fixture_path("apbec");
