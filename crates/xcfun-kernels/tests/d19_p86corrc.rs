//! Phase 6 Plan 06-N1 (B-6 revision-1) — D-19 regression detector for P86CORRC.
//!
//! Loads `validation/fixtures/d19_n1/p86corrc_baseline.jsonl` and asserts the
//! current Rust `p86corrc_kernel` output (energy / CNST coefficient at N=0)
...
#[test]
fn d19_p86corrc_baseline_regression() {
    let path = fixture_path("p86corrc");
