//! Phase 6 Plan 06-N1 (B-6 revision-1) — D-19 regression detector for SPBEC.
//!
//! Loads `validation/fixtures/d19_n1/spbec_baseline.jsonl` and asserts the
//! current Rust `spbec_kernel` output (energy / CNST coefficient at N=0)
...
#[test]
fn d19_spbec_baseline_regression() {
    let path = fixture_path("spbec");
