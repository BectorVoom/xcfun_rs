//! Plan 06-N3 D-19 small-magnitude residual sweep — `m06x` per-functional
//! unit test (B-6 pattern from Plan 06-N1; pure-verification per I-3 Option B).
//!
//! Loads `validation/fixtures/d19_n3/m06x_baseline.jsonl` and re-runs
...
#[test]
fn d19_m06x_strict_1e_13_at_failing_strata() {
    common::run_d19_n3_contract("m06x", FunctionalId::XC_M06X);
}
