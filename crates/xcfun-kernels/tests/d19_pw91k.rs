//! Phase 6 Plan 06-N1 (B-6 revision-1) — D-19 regression detector for PW91K.
//!
//! Loads `validation/fixtures/d19_n1/pw91k_baseline.jsonl` and asserts the
//! current Rust `pw91k_kernel` output (energy / CNST coefficient at N=0)
...
#[test]
fn d19_pw91k_baseline_regression() {
    let path = fixture_path("pw91k");
