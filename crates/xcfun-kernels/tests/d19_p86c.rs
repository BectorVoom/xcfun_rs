//! Phase 6 Plan 06-N1 (B-6 revision-1) — D-19 regression detector for P86C.
//!
//! Loads `validation/fixtures/d19_n1/p86c_baseline.jsonl` and asserts the
//! current Rust `p86c_kernel` output (energy / CNST coefficient at N=0)
...
#[test]
fn d19_p86c_baseline_regression() {
    let path = fixture_path("p86c");
