//! Plan 06-N3 D-19 small-magnitude residual sweep — `m06lc` per-functional
//! unit test (B-6 pattern from Plan 06-N1; pure-verification per I-3 Option B).
//!
//! Loads `validation/fixtures/d19_n3/m06lc_baseline.jsonl` and re-runs
...
#[test]
fn d19_m06lc_strict_1e_13_at_failing_strata() {
    common::run_d19_n3_contract("m06lc", FunctionalId::XC_M06LC);
}
