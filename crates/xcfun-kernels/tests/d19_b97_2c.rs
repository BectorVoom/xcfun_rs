//! Phase 6 Plan 06-N1 (B-6 revision-1) — D-19 regression detector for B97_2C.
//!
//! Loads `validation/fixtures/d19_n1/b97_2c_baseline.jsonl` and asserts the
//! current Rust `b97_2c_kernel` output (energy / CNST coefficient at N=0)
...
#[test]
fn d19_b97_2c_baseline_regression() {
    let path = fixture_path("b97_2c");
