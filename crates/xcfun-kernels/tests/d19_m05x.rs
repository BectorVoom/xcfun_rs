//! Plan 06-N3 D-19 small-magnitude residual sweep — `m05x` per-functional
//! unit test (B-6 pattern from Plan 06-N1; pure-verification per I-3 Option B).
//!
//! Loads `validation/fixtures/d19_n3/m05x_baseline.jsonl` and re-runs
...
#[test]
fn d19_m05x_strict_1e_13_at_failing_strata() {
    common::run_d19_n3_contract("m05x", FunctionalId::XC_M05X);
}
