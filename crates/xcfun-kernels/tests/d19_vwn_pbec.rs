//! Plan 06-N3 D-19 small-magnitude residual sweep — `vwn_pbec` per-functional
//! unit test (B-6 pattern from Plan 06-N1; pure-verification per I-3 Option B).
//!
//! Loads `validation/fixtures/d19_n3/vwn_pbec_baseline.jsonl` and re-runs
...
#[test]
fn d19_vwn_pbec_strict_1e_13_at_failing_strata() {
    common::run_d19_n3_contract("vwn_pbec", FunctionalId::XC_VWN_PBEC);
}
