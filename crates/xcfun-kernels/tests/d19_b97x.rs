//! Plan 06-N3 D-19 small-magnitude residual sweep — `b97x` per-functional
//! unit test (B-6 pattern from Plan 06-N1; pure-verification per I-3 Option B).
//!
//! Loads `validation/fixtures/d19_n3/b97x_baseline.jsonl` and re-runs
...
#[test]
fn d19_b97x_strict_1e_13_at_failing_strata() {
    common::run_d19_n3_contract("b97x", FunctionalId::XC_B97X);
}
