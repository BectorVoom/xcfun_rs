...
impl Functional {
        ...
        #[cfg(feature = "testing")]
        {
            match self.mode {
                ...
                Mode::Contracted => {
                    ...
                    crate::functionals::contracted::launch_contracted(self, input, output)?;
                }
    ...
    pub fn output_length(vars: Vars, mode: Mode, order: u32) -> Result<usize, XcError> {
        match mode {
            Mode::PartialDerivatives => Ok(taylorlen(Self::input_length(vars), order as usize)),
            Mode::Potential => {
...
fn launch_and_accumulate(
    ...
    match order {
        ...
        3 => {
            ...
            launch_and_accumulate(id_u32, vars_u32, 2, inlen, input, weight, output)?;
        ...
        4 => {
            ...
            launch_and_accumulate(id_u32, vars_u32, 3, inlen, input, weight, output)?;
