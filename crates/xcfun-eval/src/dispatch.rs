...
///
/// Plan 02-04 ships 9 supported ids: XC_SLATERX (0), XC_VWN3C (2), XC_VWN5C (3),
/// XC_LDAERFX (13), XC_LDAERFC (14), XC_LDAERFC_JT (15), XC_TFK (24),
/// XC_PW92C (28), XC_PZ81C (55). Plan 02-05 will add TW (25) + VWK (59).
pub fn supports(id: FunctionalId) -> bool {
    matches!(
        id as u32,
        0 | 2 | 3 | 13 | 14 | 15 | 24 | 28 | 55
    )
}
